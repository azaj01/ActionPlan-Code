...
def slerp(q0, q1, t):
    ...
    :param q0: Start quats (w, x, y, z) : shape = (B, J, 4), torch tensor
    :param q1: End quats (w, x, y, z) : shape = (B, J, 4), torch tensor
    :param t:  Step (in [0, 1]) : shape = (B, T, J, 1), torch tensor 
    :return: Interpolated quat (w, x, y, z) : shape = (B, T, J, 4)
     return shape: (B, T, 1, 4), torch tensor. 
    """
