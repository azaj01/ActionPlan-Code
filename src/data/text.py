# Adapted from STMC: src/data/text.py
# Upstream repo: https://github.com/nv-tlabs/stmc
# Source file: https://github.com/nv-tlabs/stmc/blob/main/src/data/text.py
...
class TextEmbeddings:
    ...
    def __init__(
        ...
        if dataname != "":
            ...
            raise ValueError("Either dataname or path must be provided")
        self.cache = {}
        self.device = device
