# Adapted from MotionStreamer: models/causal_cnn.py
# Upstream repo: https://github.com/zju3dv/MotionStreamer/
# Source file: https://github.com/zju3dv/MotionStreamer/blob/main/models/causal_cnn.py

"""Causal CNN encoder/decoder for TAE."""
