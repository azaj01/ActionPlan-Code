# Adapted from STMC: src/model/text_encoder.py
# Upstream repo: https://github.com/nv-tlabs/stmc
# Source file: https://github.com/nv-tlabs/stmc/blob/main/src/model/text_encoder.py
...
def TextToEmb(modelpath: str, mean_pooling: bool = False, device: str = "cpu"):
    ...
    # hugging face
    if "distilbert" in modelpath:
        return TextToEmbTMR(modelpath, mean_pooling, device)
    else:
